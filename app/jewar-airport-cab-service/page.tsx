...
//   title: "Noida International Airport Taxi and car rental | Jewar Airport self drive cars & Cabs ",
//   description:
//     "Book taxi, cab and self-drive car rentals for Noida International Airport (Jewar Airport). Reliable airport transfers across Delhi NCR.",
// };
...
export const metadata: Metadata = {
  title:
    "Noida International Airport Taxi and car rental | Jewar Airport self drive cars & Cabs |",
  description:
    "Book taxi, cab and self-drive car rentals for Noida International Airport (Jewar Airport). Reliable airport transfers across Delhi NCR.",
};
...
const pageCss = `
/* ============================================================
   GRAB YOUR CAB — noida-international-airport-taxi page styles
   Maroon red #9f1c33 · slate #33414f · white/grey sections
   ============================================================ */
:root{
  --red:#9f1c33;--red-dark:#7e1628;--slate:#33414f;--slate-dark:#2c2e36;
...
const serviceUses = [
  ...
  "From City to air port Transfers",
  "Airport to city Transfers",
  "One way cab from Airport",
  "Round trip taxi at the airport",
  "Airport Transfers for Families and Groups",
  "Corporate & Business travel",
  "Early morning and late night trips for Jewar Airport",
];

const services = [
  {
    title: "Delhi to Jewar Airport Cab",
    text: "A Delhi to Jewar Airport cab offers a one stop travel for air passenger across the Delhi to Jewar Airport in which you can easily travel from different parts of Delhi to Airport. You can book outstation cab for the pickup from home, hotel, office or any other place of your convenience.",
  },
  {
    title: "Noida to Jewar Airport Cab",
    text: "Travel comfortably from Noida to Noida International Airport (Jewar Airport) with Grab Your Cab. We offer reliable airport taxi services, one-way cabs, round trips, and self-drive car, luxury car rental, Tempo Travelers, Luxury Bus on rent for travelers across all major areas of Noida, including Sector 18, Sector 62, Sector 63, Sector 137, Sector 142, and Sector 150. Whether you're travelling from a residential area, corporate office, or the Noida Expressway, enjoy comfortable airport transfers, affordable fares, easy booking, and 24/7 customer support with Grab Your Cab.",
  },
  {
    title: "Greater Noida to Jewar Airport Cab",
    text: "Planning a trip from Greater Noida to Noida International Airport (Jewar Airport)? Grab Your Cab provides dependable airport cabs, one-way and round-trip taxi services, and self-drive car rentals across Greater Noida. Get easy airport transfers from Pari Chowk, Knowledge Park, Alpha, Beta, Gamma, and Greater Noida West, or Noida Extension with economic fare, simple booking process, sanitized cars, and 24/7 customer support.",
  },
  {
    title: "Noida International Airport Transfer Service",
    text: "Need a planned airport pickup or drop? Grab Your Cab provide 24 hours airport transfer services for individuals, families, corporate travellers, and groups from all the areas of Delhi NCR and Meerut. Book your vehicle in advance to avoid last time hassle for travel to or from Noida International Airport, Jewar by choosing a vehicle that suits your comfort and luggage requirements.",
  },
  {
    title: "Local Taxi Service in Noida",
    text: "Grab Your Cab offers local taxi services for customers travelling between residential areas, offices, hotels, commercial locations, from Noida International Airport. Book a cab for local travel or combine your local journey with an airport transfer.",
  },
  {
    title: "Outstation Cab from Noida International Airport",
    text: "Planning your journey outside Noida or Delhi NCR after arriving at Jewar Airport? Grab Your Cab provides outstation cab services for passengers travelling from Noida International Airport to destinations outside the local area. Choose a suitable vehicle 5 Seater or 7 Seater for individual, family, or group travel.",
  },
  {
    title: "Outstation Cab from Noida International Airport",
    text: "Looking for an economical one-way cab to or from Noida International Airport (Jewar Airport)? Why pay for a return journey when you are travelling only one way? With Grab Your Cab, you pay for the one-side distance for your one-way trip, helping you save on unnecessary return-distance charges. Whether travelling from Noida, Greater Noida, Delhi NCR, or nearby cities, book a comfortable and convenient one-way airport cab with Grab Your Cab.",
  },
  {
    title: "Self Drive Cars Near Noida International Airport",
    text: "Do you like to drive yourself? Grab Your Cab offers self-drive car rental options for customers travelling to or from Noida International Airport (Jewar Airport). Customers have option to select cars from various segment may it be Hatchback, Sedan, MiniSUV, SUV and luxury cars. We have all types of fuel and transmission both Manual and Automatic. Self-drive cars provide flexibility for business trips, family travel, local use, and longer journeys. Choose a suitable vehicle and arrange your booking in advance.",
  },
  {
    title: "Luxury Car Rental at Jewar Airport (Noida Airport)",
    text: "Grab Your Cab offers luxury car rental options for business travel, special occasions, weddings, corporate requirements, or premium airport transportation. We offer all type of luxury brand Toyota, Kia, MG, Audi, BMW, Mercedes, Jaguar, Ranger Rover, Rolls Royce, Hummer etc.according to your travel requirements and enjoy a comfortable journey to or from Noida International Airport.",
  },
  {
    title: "SELF DRIVE AUTOMATIC CAR IN JEWAR AIRPORT",
    text: "Looking for a self-drive automatic car on rent from Jewar Airport, Noida International Airport? Grab Your Cab provide self-drive automatic car rental options in all segment for customers who prefer to drive themselves after arriving at Jewar Airport. Whether you're visiting Noida, Greater Noida, Delhi NCR, travelling for business, or planning an outstation trip, you can choose an automatic self-drive car according to your travel requirements and rental duration. Book your self-drive automatic car from Noida International Airport in advance and enjoy the flexibility to travel at your own pace without depending on a taxi or chauffeur. Vehicle options are subject to availability and rental terms.",
  },
  {
    title: "Tempo Traveller for Noida International Airport",
    text: "Travelling with a larger family, group, or corporate team? A Tempo Traveller can be a practical option for airport transportation. Grab Your Cab provides all type of Tempo Traveller services for group transfers to and from Jewar Airport, helping passengers travel together with space for people and luggage. Grab your Cab provide 09 Seater, 12 Seater, 16 Seater, 18 Seater, 20 Seater, 26 Seater Tempo Travellers",
  },
  {
    title: "Force Urbania for Jewar Airport",
    text: "Seeing the popularity of Force Urbania Tempo Traveller on rent, Grab your Cab provides 09 Seater, 12 Seater, 16 Seater Tempo Traveller for all your local travel, outstation travel and Airport transfer. Force Urbania is available for airport transfers and group journeys. Book a Force Urbania for Noida International Airport travel when you need additional passenger space, comfortable seating, and room for luggage.",
  },
  {
    title: "Caravan Rental Near Noida International Airport",
    text: "Looking for a caravan for a trip, event, production, leisure journey, or special travel requirement? Grab Your Cab offers caravan rental options based on availability and booking requirements. Contact us to discuss your travel plans and vehicle requirements.",
  },
  {
    title: "Luxury Bus Rental for Jewar Airport",
    text: "For large groups, corporate teams, events, weddings, and organised travel, a luxury bus can provide a convenient group transportation solution. Grab Your Cab provides luxury bus rental services and Volvo bus for journeys to and from Noida International Airport, subject to vehicle and route availability.",
  },
  {
    title: "Women-Only Taxi Service",
    text: "Grab Your Cab is committed to maintaining the highest standards of safety, reliability, and customer care, therefore we offer, women-focused taxi service options subject to availability and advance booking for passenger who specifically are looking for woman only taxi arrangement. The Taxis are GPS enabled with SOS Emergency button and every car where only woman are travelling monitored by back office team which makes us the safest and best Cab for woman in Delhi NCR. Contact our booking team to discuss your requirements and arrange a suitable travel option.",
  },
  {
    title: "Pet-Friendly Taxi Service at Jewar Airport",
    text: "The love and care for pets is growing every day, and for many families, pets are an important part of life. Travelling without them is often not an option. However, many taxi and cab services do not allow pets, which often creates challenges for pet owners. To support animal lovers, Grab Your Cab offers pet-friendly taxi services to and from Noida International Airport (Jewar Airport). Whether you're travelling from Noida, Greater Noida, Ghaziabad, Gurgaon, Faridabad, Delhi, or anywhere in NCR, you can book a pet-friendly cab and travel comfortably with your furry companion. For a smoother journey, we recommend booking your pet-friendly airport taxi in advance and avoiding last-minute travel hassles. Because every trip is better when your pet can travel with you.",
  },
  {
    title: "Self Drive Car rental with Armed Bodyguard or PSO",
    text: "Need privacy, flexibility, and enhanced personal security while travelling? Grab Your Cab offers self-drive car rental or car rental with driver options with an Armed Bodyguard / PSO (Personal Security Officer) for clients with specialized security requirements. This service can be suitable for celebrities, social media influencers, event management companies, business executives, VIP guests, and high-profile individuals who require both independent mobility and professional security support. Whether travelling for events, business meetings, brand appearances, weddings, or private engagements, clients can plan their journey with greater convenience and confidence. Advance booking is recommended to discuss travel requirements, availability, and applicable legal and security arrangements.",
  },
];
...
const faqs = [
  {
    q: "How can I book a cab for Jewar Airport?",
    a: "You can contact 24 hour customer care or book cab online from website by providing your pickup location, destination, travel date, time, passenger count, and preferred vehicle to arrange your airport transfer.",
  },
  {
    q: "Does Grab Your Cab provide pickup from Jewar Airport?",
    a: "Yes, airport pickup can be arranged based on your destination, travel requirements, and cab availability at the time of booking.",
  ...
  {
    q: "How much does a cab to Jewar Airport cost?",
    a: "The fare depends on the route, distance, vehicle category, travel date, and one-way or round-trip requirement. Confirm the applicable fare before booking. The minimum fare however starts from Rs. 500 for Cab and Rs. 1500/Day in self drive segment.",
  },
  {
    q: "What types of cars are available for Jewar Airport transfers?",
    a: "Maruti, Kia, Mahindra, Hyundai, MG, Toyota, Tata etc. Also in Luxury cars Audi, BMW, Mercedes, Range Rover etc. Brands are available depending on passenger requirements and fleet availability.",
  },
  {
    q: "Can I book a cab for a family with luggage?",
    a: "Yes. Share the number of passengers and luggage requirements so that a suitable vehicle category can be considered.",
  ...
  {
    q: "Can I rent an automatic self-drive car from Jewar Airport?",
    a: "Yes, Grab Your Cab offers automatic self-drive car rental options from Noida International Airport (Jewar Airport), subject to vehicle availability. You can book a car based on your travel dates, rental duration, and vehicle requirements.",
  },
  {
    q: "Do you provide one-way outstation cabs from Noida International Airport?",
    a: "Yes, Grab Your Cab provides one-way outstation cab services in Noida international airport, Jewar for all the nearby districts and states.",
  },
  {
    q: "Do you provide taxis from Greater Noida to Jewar Airport?",
    a: "Yes, Grab Your Cab provides taxi and cab services from Greater Noida areas such as Pari Chowk, Knowledge Park, Alpha, Beta, Gamma, and Greater Noida West to Noida International Airport.",
  },
  {
    q: "Can I book a self-drive car near Jewar Airport?",
    a: "Yes, self-drive car rental options are available through Grab Your Cab, subject to vehicle availability and booking requirements.",
  },
  {
    q: "Do you provide luxury cars for Noida International Airport?",
    a: "Yes, Grab Your Cab offers luxury car rental options for airport transfers, business travel, special occasions, and other travel requirements, subject to availability.",
  },
  {
    q: "Can I book a Tempo Traveller for Jewar Airport?",
    a: "Yes, Tempo Traveller services are available for families, groups, corporate teams, and other passengers travelling to or from Noida International Airport.",
  },
  {
    q: "Is Force Urbania available for Jewar Airport transfers?",
    a: "Yes, you can enquire about Force Urbania for group airport transfers and other journeys to or from Noida International Airport, subject to availability.",
  },
  {
    q: "Do you provide outstation cabs from Jewar Airport?",
    a: "Yes, Grab Your Cab provides outstation cab services for passengers travelling from Noida International Airport to destinations outside the local area.",
  },
  {
    q: "Can I travel with my pet in a taxi from Jewar Airport?",
    a: "Pet-friendly taxi options may be available subject to vehicle availability and applicable travel requirements. Inform Grab Your Cab about your pet when making your booking.",
  },
  {
    q: "Do you provide women-only taxi services?",
    a: "Women-only taxi arrangements may be available subject to driver and vehicle availability. Advance booking is recommended.",
  },
  {
    q: "Can I arrange a self-drive car with a PSO or armed bodyguard?",
    a: "Security-supported travel arrangements may be available subject to applicable permissions, availability, and legal requirements. Contact Grab Your Cab in advance to discuss your specific requirements.",
  },
];

export default function NoidaInternationalAirportTaxiPage() {
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: pageCss }} />
      <Header />
      ...
      <section className="page-hero">
        <div className="container">
          ...
          <span className="eyebrow">Noida International Airport · Jewar</span>
          <h1>Noida International Airport, Jewar Cab Service for Easy Airport Transfers</h1>
          <p className="lead">
            ...
            or to reach there. Whether you need an airport drop for Noida International airport,
            Jewar, or a pickup at the airport after your landing or need to catch an airport
            transfer from another city, you'll be able to pick the best cab options as per you
          ...
          <div className="seo-wrap">
            <div className="seo-block">
              <p>
                ...
                your trip, even before you start your journey. Grab Your Cab caters for your
                travel needs at competitive rates. Travel from and to, The Grab Your Cab offers a
                comfortable journey to Jewar Airport from Noida, Greater Noida, Delhi, Gurgaon,
                Ghaziabad, Meerut and other nearby regions.
              </p>
            </div>
            ...
            <div className="seo-block">
              ...
              <p>
                A Jewar Airport taxi service is a great choice for incoming as well as outgoing
                travelers. You can book a ride from your house, hotel, office or any other place
                to the airport, or get a cab from the airport to your destination.
                <br />
                The service can utilized for:
              </p>
            </div>
          </div>
        </div>
      ...
      {/* ---------- CAB SERVICE TO/FROM NOIDA INTERNATIONAL AIRPORT ---------- */}
      <section className="sec">
        <div className="container">
          <div className="sec-head">
            <span className="eyebrow">Where We Connect</span>
            <h2>Cab Service to and From Noida International Airport</h2>
            <p>
              Grab Your Cab is available for airport outstation taxi rides from Noida
              International Airport to most places in the Delhi-NCR area. The value of the right
              vehicle and fare is determined by the route, trip needs, and booking information.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="sec grey">
        <div className="container">
          <div className="sec-head">
            ...
            <h2>Taxi, Cab &amp; Car Rental Services for Jewar Airport</h2>
          </div>
          <div className="svc-grid">
            {services.map((item, i) => (
              <div className="svc-card" key={`${item.title}-${i}`}>
                <h3>{item.title}</h3>
                <p>{item.text}</p>
              </div>
            ))}
      ...
      <section className="sec">
        <div className="container">
          <div className="seo-wrap">
            <div className="seo-block">
              <h2>Areas We Serve for Jewar Airport Transfers</h2>
              <p>
                Grab Your Cab provides taxi, cab, self-drive car rental, luxury car rental, Tempo
                Traveller, Force Urbania, caravan, and airport transfer services to and from Noida
                International Airport (Jewar Airport). We serve travellers across Delhi NCR,
                including Noida, Greater Noida, Ghaziabad, Delhi, Gurugram, and Faridabad. Our
                services are also available for customers travelling from nearby cities and
                districts across Uttar Pradesh, Haryana, Rajasthan, Uttarakhand, Himachal Pradesh,
                and other parts of North India. Whether you need an airport taxi, self-drive car,
                luxury vehicle, or group transportation, we offer travel solutions for
                individuals, families, corporate travellers, and event groups. Advance booking is
                recommended to ensure vehicle availability and a smooth travel experience to or
                from Jewar Airport.
              </p>
            </div>

            <div className="seo-block">
              <h2>How to Book a Noida International Airport Taxi or Car Rental?</h2>
              <p>
                You can book a taxi, cab, airport transfer, self-drive car, luxury vehicle, or
                group transportation service with Grab Your Cab by contacting our 24 hours
                customer care or using our online booking option. Share your travel date, pickup
                location, airport destination, number of passengers, luggage requirements, and
                preferred vehicle type so we can help arrange the appropriate service.
              </p>
            </div>

            <div className="seo-block">
              <h2>Why Choose Grab Your Cab for Jewar Airport Travel?</h2>
              <p>
                Grab Your Cab offers a wide range of travel and mobility solutions for passengers
                travelling to and from Noida International Airport (Jewar Airport). Unlike many
                providers that focus on a single service, we bring together airport taxis, local
                cabs, one-way and outstation travel, self-drive car rentals, luxury car rentals,
                Tempo Travellers, Force Urbania, caravans, luxury buses, pet-friendly taxis,
                women-focused taxi options, and specialised travel arrangements under one
                platform. Whether you are an individual traveller, family, corporate client, event
                organiser, celebrity, influencer, or business professional, you can choose a
                travel solution that matches your requirements. Our goal is to provide
                flexibility, convenience, and reliable transportation options through a single
                trusted service provider. With services available across Delhi NCR and beyond,
                Grab Your Cab makes airport travel simpler by offering multiple mobility solutions
                under one roof.
              </p>
            </div>
            ...
            <div className="seo-block">
              <h2>Why Book Your Jewar Airport Cab in Advance?</h2>
              <p>
                Booking in advance allows you more time to plan your route, pick-up point, vehicle
                choice and travel time. This is especially beneficial for people who have fixed
                flight schedule, travelling with family, group of persons and late night journey.
              </p>
              <p>
                A scheduled Jewar Airport taxi ride can also lessen the anxiety of finding
                transportation when you arrive.
        ...
        <div className="container">
          <div className="banner">
            <div className="in">
              <h2>Book Your Jewar Airport Cab with Grab Your Cab</h2>
              <p>
                Schedule your airport ride for delivery and pickup from a convenient location near
                you with Jewar Airport cab, while we cater to your route, destination, passengers,
                and travel timings. If you are looking for a reliable taxi service in Jewar or want
                to book a cab from Jewar to Noida International Airport or an airport transfer
                from Noida to Delhi-NCR then look no further than Grab Your Cab as we can help you
                book the perfect travel option.
              </p>
              <p>
                Book your Jewar Airport taxi with Grab Your Cab and get to or from the airport
                with ease on reliable, pre-booked transportation.
              </p>
              <div className="hbtns">
                <a href="https://wa.me/917522817555" className="btn btn-wa">
                  Book on WhatsApp
      ...
      <section className="sec grey">
        <div className="container">
          <div className="garage-head">
            <h2>Our Noida International Airport Taxi Service Office</h2>
            <hr />
          </div>
          <div className="garage-grid">
            <div className="garage-map">
