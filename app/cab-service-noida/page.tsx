...
/* Types of Cab Services Available in Noida - EXACT MATCH from document */
const cabServiceTypes = [
  {
    title: "Noida Local Cab Service",
    image: "https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=600",
    text: "Local taxi service is ideal for you if you want to travel to daily places for shopping, meetings, appointment, family visit, place to place journeys. Book a cab in Noida as per your pickup location and destination.",
  },
  {
    title: "Airport Cab Services in Noida",
    image: "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=600",
    text: "It is easy to travel from Noida to Delhi Airport or Noida Airport Jewar when you hire your transportation ahead of time. An airport taxi may come in handy for early-morning departures, late-night arrivals, business travel, and trips involving luggage. Arrange for pickup and drop-off according to your flight timings.",
  },
  {
    title: "Outstation Taxi Service in Noida",
    image: "https://images.unsplash.com/photo-1502877338535-766e1452684a?w=600",
    text: "If you are a tourist looking for an outstation taxi service in Noida, then we have got you covered. Agra, Jaipur, Mathura, Haridwar, Rishikesh, Khatushyam baba, Neem Karoli, Nainital, Shimla, Manali, Delhi and Gurgaon are some of the most preferred destinations. Depending on the trip, travellers have the option to opt for one-way and round-trip packages.",
  },
  {
    title: "One-Way Cab Service in Noida",
    image: "https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=600",
    text: "Travel from Noida to any outstation destination and dont pay for the return journey. Company charge only for the one-side distance, making this a rare and highly cost-effective one way cab model and that makes it one of the most affordable one-way outstation cab services from Noida.",
  },
  {
...
/* Popular Cab Routes from Noida - EXACT MATCH from document */
const popularRoutes = [
  "Noida to Delhi",
  "Noida to Gurgaon",
  ...
  "Noida to Haridwar",
  "Noida to Rishikesh",
  "Noida to Khatushyam Baba",
  "Noida to Neem karauli baba",
];

/* Cab Options for Different Travel Needs - EXACT MATCH from document */
const carsAvailable = [
  {
    title: "Wedding car rental in Noida",
    text: "Client can choose best car rental option for wedding may it be be luxury cars or 7 seater, Tempo Travellers or luxury bus to pickup and drop off guests from guest house to marriage function. There is a proper wedding travel management which one can choose as per requirement.",
  },
  {
    title: "Luxury car Rental Noida",
    text: "Choose from a wide range of premium and luxury cars for weddings, corporate travel, events, airport transfers and special occasions: Toyota Fortuner | Kia Carnival | Audi | BMW | Mercedes-Benz | Jaguar | Range Rover | Defender | Rolls-Royce | Hummer. Whether you need a powerful SUV or a premium luxury car, choose the vehicle that matches your occasion and style.",
  },
  {
    title: "Cars for Business Travel",
    text: "Business travelers need convenient pickup and drop-off to and from offices, hotels, airports and meeting locations. Having a well maintained car and experienced driver available 24 hours can make transportation much simpler for any business travel requirement.",
  },
];

/* How to Book a Cab in Noida - EXACT MATCH from document */
const bookingSteps = [
  { title: "Enter the location", text: "Enter the location where you want to get picked and the destination." },
  { title: "Choose a vehicle", text: "Choose a vehicle or a travel solution." },
  { title: "Tell us your date and time", text: "Tell us your date and time of pickup." },
  { title: "Verify the information", text: "Verify the passenger and trip information." },
  { title: "Make the booking", text: "Make the booking and get the trip details you need." },
];

/* Cab Service in Noida for Airport, Railway Station & Business Travel - EXACT MATCH from document */
const travelServices = [
  {
    title: "Airport Transfers",
    text: "Airport transfers etc are organized for passengers travelling from Noida to Delhi Airport or noida International airport jewar and vice-versa 24 hours. Please provide your flight details while booking so that we can schedule your pick up accordingly.",
  },
  {
    title: "Railway Station Transfers",
    text: "You can also take a taxi for direct taxi service from Noida to Delhi Railway Station, Nizzamuddin, Sarai kale khan, Old delhi railway station, etcand other places in and around Delhi to travel light.",
  },
  {
    title: "Corporate & Business Travel",
    text: "Reliable corporate travel management for companies, including employee pick-up and drop services, airport transfers, and dedicated VIP luxury cars for MDs, CEOs, CFOs and senior executives. We also provide a wide range of 7-seater and premium vehicles to meet different corporate travel requirements.",
  },
  {
    title: "Family & Group Travel",
    text: "Large Families have the option of choosing a 7 seater car with options of Maruti Ertiga, Kia Carrens, Toyota Innova Crysta, Innova Hycross, XUV 700, Mahindra Scorpio, Toyota Fortuner etc, For group tour 9, 12, 16, 18, 20 & 26 Seater Luxury Tempo Travellers in Noida, Maharaja Temp Traveller, Force Urbania Traveller in Noida Mercede Traveller are available at all locations of Nouda and Greater Noida. Also for large group tours 27, 32, 40, 45, 50 and 60 seater luxury Bus, Volvo luxury Bus in Noida are available 24 hours for coporate tours, wedding group tour or all type of pilgrimage tours. Vehicles are chosen based on the number of passengers as well as the amount of luggage they have, allowing them to more easily plan both local and outstation tours.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes, airport transfers can be arranged between Noida and Delhi Airport, also Noida to Jewar Airport, 24 hours dedicated cabs are ready around the clock,",
  },
  {
    q: "Do you provide outstation cab service from Noida?",
    a: "Yes, outstation travel are arranged for destinations such as Agra, Jaipur, Mathura, Haridwar, Rishikesh, Nainital, Neem Karauli baba, Khatushyam Baba, Shimla and Manali",
  },
  {
    q: "Can I book a one-way cab from Noida?",
    a: "Yes, one-way bookings are suitable when you need transportation to an outstation destination without requiring the same cab for the return journey and wants to pay only for one side.",
  },
  {
  ...
  },
  {
    ...
    a: "Cab bookings can be arranged across major Noida sectors Noida Extension and Greater Noida depending on the requested route, vehicle, and availability.",
  },
  {
    q: "Can I book a cab for a family or group?",
    a: "Yes. Select a vehicle may it be 7 seaters cab, Tempo Travellers or Luxury Volvo bus according to the number of passengers and amount of luggage you need to carry.",
  },
  {
...
export default function CabServiceNoidaPage() {
  return (
    <>
        ...
        <div className="container">
          <div className="seo-wrap">
            <div className="seo-block">
              ...
              <p>
                A cab can make day-to-day travel easier when you want direct transportation without the hassle of driving, parking or navigating through unfamiliar routes. Grab Your Cab serves local traveling around Noida and also at the city exits to Delhi, Gurgaon, Greater Noida, airports, railway stations, and the most favourite outstation destinations.
              </p>
              <p>
                Whether you require a taxi for meetings in sector 62, an airport transfer from sector 137 or an intercity trip to Agra, on the basis of travel distance, time, number of passengers or luggage, you can opt for an appropriate travel package.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* ---------- WHY CHOOSE OUR CAB SERVICE - EXACT MATCH ---------- */}
        ...
        <div className="container">
          <div className="seo-wrap">
            <div className="seo-block">
              ...
              <p>
                A neat and clean car, highly maintained with experience and skilled driver is what we offer to each client. The booking process is very simple and client can easily book taxi online and offline. Some special and customized service which separate it from other cab companies are woman only taxi, pet friendly cab, special cab for elderly people, taxi for disabled person, cab with attendent, wedding cars, event transportation etc. Important things to keep in mind include clear details about your trip, suitable vehicles, convenient pick-up locations, ability to communicate with the driver, and impartial details about any costs involved.
              </p>
              <p>
                We committed to simplifying these so that our customer can plan both their local and outstation trips with deliverance.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* ---------- POPULAR CAB ROUTES - EXACT MATCH ---------- */}
      <section className="sec grey">
        <div className="container">
          <div className="sec-head">
            ...
            <p>
              Noida is well connected with Delhi, Gurgaon, Greater Noida and various cities of north India through road. Frequently required routes include:
            </p>
          </div>
          ...
          <p style={{ textAlign: "center", marginTop: 20, color: "var(--muted)", fontSize: "13.5px" }}>
            The right size vehicle must be chosen for houseguests, bags and distance and length of travel when travelling long distances.
          </p>
        </div>
      </section>

      {/* ---------- CAB OPTIONS FOR DIFFERENT TRAVEL NEEDS - EXACT MATCH ---------- */}
      <section className="sec">
        <div className="container">
          <div className="sec-head">
      ...
      <section className="sec grey">
        <div className="container">
          <div className="sec-head">
            ...
            <p>
              Booking a cab in Noida can be easily:
            </p>
          </div>
          <div className="steps">
          ...
          <p style={{ textAlign: "center", marginTop: 24, color: "var(--muted)", fontSize: "14px" }}>
            When you know you will be travelling to the airport or to another city for a planned trip, booking in advance allows you to organize the trip around your schedule.
          </p>
        </div>
      </section>

      {/* ---------- WHY BOOK A CAB INSTEAD OF DRIVING - EXACT MATCH ---------- */}
      <section className="sec">
        <div className="container">
          <div className="seo-wrap">
            <div className="seo-block">
              ...
              <p>
                Taking a cab can be more convenient if you want to stay away from parking, directions, traffic-related driving anxiety, or driving on an unfamiliar road. It is also helpful while traveling with family, all the baggage, business meetings or for a trip to the airport or outstation.
              </p>
              <p>
                For longer trips, traveling as a group in a single vehicle may be easier to coordinate. Also if your job requires lots of phone calls, taking a cab with driver is the best option to ensure safety.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* ---------- AREAS COVERED - EXACT MATCH FROM DOCUMENT ---------- */}
      <section className="sec grey">
        <div className="container">
          <div className="seo-wrap">
            <div className="seo-block">
              ...
              <p>
                You can avail the benefits of your cab booking in Noida in all major residential, commercial, and business areas of the city like Sector 15, Sector 16, Sector 18, Sector 27, Sector 37, Sector 44, Sector 50, Sector 51, Sector 61, Sector 62, Sector 63, Sector 75, Sector 76, Sector 137 and Sector 142, Yamuna Expressway, Knowledge Park, pari chowk, Greater Noida Areas Alphsm beta, gama etc. It also has offices and good services in Gaur City Ek Murti, Sector 1, techzone 4m Bisrakh and all areas comes in Noida Extension or greater noida west.
              </p>
              <p>
                Also, the service can be availed for travel between Noida and Greater Noida, as well as to and from the satellite towns of the NCR, depending on the route and availability.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* ---------- AIRPORT, RAILWAY STATION & BUSINESS TRAVEL - EXACT MATCH ---------- */}
      <section className="sec">
        <div className="container">
          <div className="sec-head">
      ...
      {/* ---------- WHAT MAKES A GOOD CAB SERVICE - EXACT MATCH ---------- */}
      <section className="sec grey">
        <div className="container">
          <div className="seo-wrap">
            <div className="seo-block">
              ...
              <p>
                Clear information on making a booking, good options of vehicle choice, well maintained cabs, Experienced drivers, transparent pricing, timely reporting and 24 hours dedicated customer care make a transport service reliable. Customers should also be made aware of any relevant cancellation, waiting, toll, parking or trip-extend policies before confirming a booking.
              </p>
              <p>
                These are the elements that help travellers to make an informed decision instead of opting for something which has the lowest fare in the market.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="seo-wrap">
            <div className="seo-block">
              ...
              <p>
                Taxi charges in Noida are subject to a number of factors such as pick-up and drop location, distance, type of vehicle, duration of travel, kind of trip and trip type such as local, airport, one way and round trip. Tolls, parking, and other charges may also be added to the final fare.
              </p>
              <p>
                Please don't just blindly pick the cheapest taxi in Noida, but compare the total fare, exclusions, vehicle suitability and booking term for your own route.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* ---------- BOOK CAB SERVICE WITH GRAB YOUR CAB - EXACT MATCH ---------- */}
      <section className="sec grey">
        <div className="container">
          <div className="seo-wrap">
            <div className="seo-block" style={{ marginBottom: 0 }}>
              ...
              <p>
                Grab Your Cab provides transportation from Noida for your local journeys, Intercity travel, outstation, one way cab and airport transfers. select the suitable vehicle from the wide range of cabs and know the estimate price as per duration and destination.
              </p>
              <p>
                Reserve your cab in Noida with Grab Your Cab and hop on your next trip on your own preferred time of the day.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="garage-grid">
            <div className="garage-map">
              ...
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.594270369845!2d77.3803626!3d28.6119462!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cef49fdd938e9%3A0x6762693a8f4af6e9!2sGrab%20Your%20Cab!5e0!3m2!1sen!2sin!4v1790069882106!5m2!1sen!2sin"
                loading="lazy"
